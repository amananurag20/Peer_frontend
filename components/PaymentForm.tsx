...
export default function PaymentForm() {
    return (
        <div className="w-full max-w-[500px]">
            <h1 className="text-3xl md:text-4xl font-normal text-gray-900 mb-2 text-center sm:text-left">
                Online Citation Payment
            </h1>
            <p className="text-gray-500 text-sm mb-6 leading-[1.6] max-w-[420px] text-center sm:text-left">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2.5 bg-white relative focus-within:border-gray-500 transition-colors">
                        <div className="text-gray-400 mr-2 flex items-center justify-center">
                            <span className="font-serif text-[18px] leading-none font-bold italic mr-1">99</span>
                        </div>
                        <input
                            type="text"
                ...
                <div className="flex items-center justify-start text-gray-500 font-semibold text-xs">
                    OR
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex justify-between items-center gap-3">
                        <input
                            type="text"
                            placeholder="MM"
                            className="flex-1 border border-gray-300 rounded-lg px-3 py-2.5 outline-none text-gray-800 text-sm placeholder-gray-400 bg-white focus:border-gray-500 transition-colors text-center"
                            maxLength={2}
                        />
                        <input
                            type="text"
                ...
                <div className="flex items-center gap-4 mt-4">
                    <div className="flex-1 flex justify-center">
                        <button className="text-green-600 font-bold text-sm px-8 py-2.5 hover:bg-green-50 rounded-lg transition-colors">
                            Clear
                        </button>
                    </div>
                    <button disabled className="flex-1 bg-[#e2e2e8] text-[#9a9a9a] font-semibold text-sm py-2.5 rounded-lg cursor-not-allowed transition-colors text-center">
                        Next
                    </button>
                </div>
            </div>
